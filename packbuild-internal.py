...
def main():
    ...
    if args.repository == "am":
        try:        
            #git clone 
            command_string = 'git clone git@git.artefactual.com:archivematica-internal.git archivematica'
        ...
        try:        
            #git clone 
            command_string = 'git clone git@git.artefactual.com:archivematica-storage-service-internal.git archivematica-storage-service'
            run_subprocess(command_string, cwd=working_dir)
